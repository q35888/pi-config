---
name: mobile-reverse
description: 移动端逆向工程。Android APK + iOS IPA 统一方法论。Frida/Objection 动态插桩、OWASP MSTG、SSL Pinning/Root/越狱检测绕过、移动端 AES/RSA/HMAC 密钥提取。触发：iOS 逆向、IPA 分析、移动端逆向、SSL Pinning bypass、root 检测绕过、越狱检测绕过、Objection、移动端密钥提取。
---
