---
name: api-security
description: API 安全测试。覆盖 REST/GraphQL/WebSocket/SOAP 全协议，10 阶段方法论。BOLA/IDOR/BFLA 授权漏洞检测、JWT/OAuth 2.0 认证测试、GraphQL 内省与别名过载。触发：API 安全、REST 测试、GraphQL、WebSocket、JWT、OAuth、BOLA、IDOR、API 授权漏洞。
---
