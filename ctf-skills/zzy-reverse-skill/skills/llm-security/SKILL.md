---
name: llm-security
description: LLM/AI 应用安全测试。覆盖 OWASP LLM Top 10 v2.0 + OWASP Agentic AI Top 10 (ASI 2026)。ChatBot/RAG/Code Assistant 安全测试、AI Agent 审计（工具调用/记忆持久化/多智能体）、Prompt 注入（直接+间接）、模型供应链、红队 AI 攻击模拟。触发：LLM 安全、AI 安全、prompt injection、agent 审计、RAG 安全、越狱测试。
---
